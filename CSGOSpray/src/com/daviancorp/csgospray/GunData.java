...
public final class GunData {
	...
	private GunData() {
		...
		data.add(new Gun("Bizon","p_bizon.gif","c_bizon.gif","n_bizon.gif",R.drawable.bizon));
		...
		data.add(new Gun("Galil","p_galil.gif","c_galil.gif","n_galil.gif",R.drawable.galil));
		data.add(new Gun("FAMAS","p_famas.gif","c_famas.gif","n_famas.gif",R.drawable.famas));
		data.add(new Gun("AK47","p_ak47.gif","c_ak47.gif","n_ak47.gif",R.drawable.ak47));
