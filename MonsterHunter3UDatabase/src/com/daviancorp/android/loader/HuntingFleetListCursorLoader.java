...
public class HuntingFleetListCursorLoader extends SQLiteCursorLoader {
	...
	private String location;	// "Moga Coast", "Dark Waters", "Nearby Island", "Moga Shallows",
								// "Moga Deep", "Legendary Tides", "Moga Strait", "Abyssal Volcano",
								// "Pirate"s Tomb", "Distant Isle", "No-man"s Land",
								// or null
	
	public HuntingFleetListCursorLoader(Context context, String type, String location) {
		super(context);
		this.type = type;
	...
	protected Cursor loadCursor() {
		...
		if (location != null) {
			return DataManager.get(getContext()).queryHuntingFleetLocation(location);
		}
		else if (type != null) {
