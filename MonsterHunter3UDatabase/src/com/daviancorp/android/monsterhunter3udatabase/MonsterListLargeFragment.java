...
public class MonsterListLargeFragment extends ListFragment implements LoaderCallbacks<Cursor> {
	...
	public Loader<Cursor> onCreateLoader(int id, Bundle args) {
		...
		return new MonsterListLargeCursorLoader(getActivity());
	}

	@Override
	public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
		// Create an adapter to point at this cursor
		MonsterListLargeCursorAdapter adapter =
				new MonsterListLargeCursorAdapter(getActivity(), (MonsterCursor) cursor);
	...
	private static class MonsterListLargeCursorAdapter extends CursorAdapter {
		
		private MonsterCursor mMonsterCursor;
		
		public MonsterListLargeCursorAdapter(Context context, MonsterCursor cursor) {
