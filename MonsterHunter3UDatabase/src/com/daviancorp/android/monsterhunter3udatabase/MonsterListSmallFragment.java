...
public class MonsterListSmallFragment extends ListFragment implements LoaderCallbacks<Cursor> {
	...
	public Loader<Cursor> onCreateLoader(int id, Bundle args) {
		...
		return new MonsterListSmallCursorLoader(getActivity());
	}

	@Override
	public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
		// Create an adapter to point at this cursor
		MonsterListSmallCursorAdapter adapter =
				new MonsterListSmallCursorAdapter(getActivity(), (MonsterCursor) cursor);
	...
	private static class MonsterListSmallCursorAdapter extends CursorAdapter {
		
		private MonsterCursor mMonsterCursor;
		
		public MonsterListSmallCursorAdapter(Context context, MonsterCursor cursor) {
